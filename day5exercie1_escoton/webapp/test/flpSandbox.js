		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#zbtpday5exercie1f11-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zbtpday5exercie1f11-display": {
								"semanticObject": "zbtpday5exercie1f11",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zbtp.day5exercie1f11",
									"url": sap.ui.require.toUrl("zbtp/day5exercie1f11")
								}
							}
						}
					}
