sap.ui.define(["sap/ui/core/mvc/Controller",
	...
	return BaseController.extend("com.sap.build.standard.employeeRecords.controller.MasterPage1", {
		handleRouteMatched: function(oEvent) {
			...
			if (!this.sContext) {
				this.sContext = "EmployeeRecordsSet('1')";
			}
		...
		_onPageNavButtonPress: function(oEvent) {
			...
			return new Promise(function(fnResolve) {
				...
				this.doNavigate("DetailPage1", oBindingContext, fnResolve, "EmployeeNumber1");
		...
		_onSearchFieldSearch: function(oEvent) {
			...
			return new Promise(function(fnResolve) {
				...
				if (sQuery && sQuery.length > 0) {
					...
					aFilters.push(new sap.ui.model.Filter("EmployeeNumber", sap.ui.model.FilterOperator.Contains, sQuery));
		...
		_onButtonPress: function(oEvent) {
			...
			return new Promise(function(fnResolve) {
				...
				this.doNavigate("DetailPage3", oBindingContext, fnResolve, "EmployeeNumber1");
			}.bind(this)).catch(function(err) {
				if (err !== undefined) {
					MessageBox.error(err.message);
				}
