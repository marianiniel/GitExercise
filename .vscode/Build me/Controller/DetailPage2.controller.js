sap.ui.define(["sap/ui/core/mvc/Controller",
	...
	return BaseController.extend("com.sap.build.standard.employeeRecords.controller.DetailPage2", {
		...
		_onButtonPress: function() {
			return new Promise(function(fnResolve) {
				...
				sap.m.MessageToast.show("Save is successful", {
					onClose: fnResolve,
					duration: 1000 || 3000,
					at: sTargetPos,
					my: sTargetPos
		...
		_onButtonPress1: function() {
			return new Promise(function(fnResolve) {
				sap.m.MessageBox.confirm("All changes will not be saved. Do you still want to continue to cancel?", {
					title: "Cancel",
					actions: ["Ok", "No"],
